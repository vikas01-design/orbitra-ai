...
const LANGUAGE_CHANNELS: Record<string, { label: string; channels: Channel[] }> = {
  english: {
    label: "English",
    channels: [
      { name: "freeCodeCamp", handle: "@freecodecamp", url: "https://www.youtube.com/@freecodecamp" },
      { name: "Derek Banas", handle: "@derekbanas", url: "https://www.youtube.com/@derekbanas" },
    ],
  },
  hindi: {
    label: "Hindi",
    channels: [
      { name: "Code With Harry", handle: "@CodeWithHarry", url: "https://www.youtube.com/@CodeWithHarry" },
      { name: "MySirG", handle: "@mysirgdotcom", url: "https://www.youtube.com/@mysirgdotcom" },
      { name: "freeCodeCamp Hindi", handle: "@freecodecamphindi", url: "https://www.youtube.com/@freecodecamphindi" },
    ],
  },
  spanish: {
    label: "Spanish",
    channels: [
      { name: "Hola Mundo", handle: "@HolaMundoDev", url: "https://www.youtube.com/@HolaMundoDev" },
  ...
  french: {
    label: "French",
    channels: [
      { name: "Grafikart", handle: "@grafikart", url: "https://www.youtube.com/@grafikart" },
      { name: "Graven", handle: "@Gravenilvectuto", url: "https://www.youtube.com/@Gravenilvectuto" },
      { name: "École du Web", handle: "@EcoleduWeb", url: "https://www.youtube.com/@EcoleduWeb" },
      { name: "Prim FX Design", handle: "@primfxdesign", url: "https://www.youtube.com/@primfxdesign" },
    ],
  },
  german: {
    label: "German",
    channels: [
      { name: "Data Science Institute", handle: "@datascience.institute", url: "https://www.youtube.com/@datascience.institute" },
      { name: "Programmieren Lernen", handle: "@Programmierenlernen", url: "https://www.youtube.com/@Programmierenlernen" },
      { name: "SemperVideo", handle: "@SemperVideo", url: "https://www.youtube.com/@SemperVideo" },
    ],
  },
  portuguese: {
    label: "Portuguese",
    channels: [
      { name: "Curso em Vídeo", handle: "@cursoemvideo", url: "https://www.youtube.com/cursoemvideo" },
      { name: "Rocketseat", handle: "@rocketseat", url: "https://www.youtube.com/@rocketseat" },
      { name: "cod3r", handle: "@cod3r", url: "https://www.youtube.com/@cod3r" },
      { name: "freeCodeCamp Português", handle: "@freecodecampemportugues", url: "https://www.youtube.com/@freecodecampemportugues" },
    ],
  },
  telugu: {
    label: "Telugu",
  ...
  tamil: {
    label: "Tamil",
    channels: [
      { name: "Code IO", handle: "@codeio", url: "https://www.youtube.com/@codeio" },
      { name: "Error Makes Clever", handle: "@ErrorMakesClever", url: "https://www.youtube.com/@ErrorMakesClever" },
      { name: "Codebinx", handle: "@codebinx", url: "https://www.youtube.com/@codebinx" },
    ],
  },
};
...
function looksNonTechnical(input: string): boolean {
  return CONVERSATIONAL_PATTERNS.some((p) => p.test(input.trim().toLowerCase()));
}
...
export default function SkillGapPage() {
  ...
  const openChannel = (channel: Channel) => {
    ...
    const url = `${channel.url}/search?query=${encodeURIComponent(channelPicker.query)}`;
          ...
          >
            ...
            >
              ...
              <p className="text-sm text-muted-foreground mb-5 leading-relaxed">
                Choose your preferred language for: <span className="text-blue-300 font-medium">"{videoPicker.title}"</span>
              </p>
      ...
      <AnimatePresence>
        {channelPicker && (
          ...
          >
            <motion.div
              initial={{ scale: 0.9, opacity: 0, y: 20 }} animate={{ scale: 1, opacity: 1, y: 0 }} exit={{ scale: 0.9, opacity: 0, y: 20 }}
              className="glass-card border border-white/10 rounded-2xl p-6 w-full max-w-sm mx-4 shadow-[0_0_40px_rgba(239,68,68,0.15)]"
              onClick={(e) => e.stopPropagation()}
            >
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                  <Youtube className="w-5 h-5 text-red-400" />
                  <h3 className="font-display font-bold text-lg">Choose a {channelLangLabel} Channel</h3>
                </div>
              ...
              <p className="text-sm text-muted-foreground mb-5 leading-relaxed">
                Searching for: <span className="text-yellow-300 font-medium">"{channelPicker.title}"</span>
              </p>
              ...
              <button
                onClick={() => { setChannelPicker(null); setVideoPicker({ query: channelPicker.query, title: channelPicker.title }); }}
                className="mt-4 w-full text-xs text-muted-foreground hover:text-white transition-colors text-center"
              >
